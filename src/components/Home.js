...
function Home() {
  return (
    ...
    <Carousel.Item interval={2000}>
      ...
      />
      <Carousel.Caption>
      <Link to="/products"><Button><h5>Explore more</h5></Button></Link>
      </Carousel.Caption>
    </Carousel.Item>
    <Carousel.Item interval={2000}>
      <img
  ...
  <Card.Body>
    ...
    <Link to="/products"><Button variant="light btn-outline-dark" className='mb-5 mt-4'>Explore products</Button></Link>
  </Card.Body>
  <Card.Footer className="text-muted  mt-4"> &copy; 2022  &nbsp;  &nbsp; &nbsp;   Designed by Shiva Karka
  </Card.Footer>
</Card>
 </>
  )
