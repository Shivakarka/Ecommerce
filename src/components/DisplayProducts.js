              ...
              <div className="h-100">
                <div className="card h-100 text-center p-4">
                  ...
                  <div className="card-body">
                    ...
                    <span  className="btn btn-outline-dark me-3" onClick={()=> {addProduct(product)}} >Add to cart</span>
                    <Link
                    ...
                    <span  className="btn btn-outline-dark ms-2 " onClick={()=> {handleDelete(product.id)}} ><FaTrash/></span>
                  </div>
                  </AnimationWrapper>
                </div>
              </div>
